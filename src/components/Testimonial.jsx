            ...
            >
              <div className="flex items-center mb-4">
                <img
                  src={t.image}
                  alt={t.name}
                  className="w-12 h-12 rounded-full object-cover border-2 border-greenGray mr-3"
                />
                <div>
                  <h4 className="text-lg font-semibold text-softGray">{t.name}</h4>
                  <p className="text-sm text-greenGray">{t.title}</p>
                </div>
              </div>
              <FontAwesomeIcon icon={faQuoteLeft} className="text-greenGray mb-2 text-xl" />
              <p className="italic text-mediumGray">"{t.review}"</p>
            </div>
          ))}
        </div>
      </div>
